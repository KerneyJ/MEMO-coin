...
C_SRCS=
CPP_SRCS=keys.cpp wallet.cpp transaction.cpp utils.cpp server.cpp \
		thread_pool.cpp block.cpp tx_pool.cpp blockchain.cpp config.cpp \
		validator.cpp pow.cpp pom.cpp metronome.cpp monitor.cpp messages.cpp
C_OBJS=$(C_SRCS:.c=.o)
